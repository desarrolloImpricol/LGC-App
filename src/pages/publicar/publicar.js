 ...
 */
var PublicarPage = /** @class */ (function () {
    function PublicarPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    PublicarPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PublicarPage');
    };
    PublicarPage.prototype.irCrearNoticias = function () {
        this.navCtrl.push(CrearNoticiaPage);
    };
    PublicarPage.prototype.irCreaEventos = function () {
        this.navCtrl.push(CrearEventoPage);
    };
    PublicarPage.prototype.irAmarilla = function () {
